...
try
{
	...
	String q1="create table users(name varchar(100),email varchar(100)primary key,mobileNumber bigint,securityQuestion varchar(200),answer varchar(200),password varchar(100),address varchar(200),city varchar(100),state varchar(200),country varchar(100))";
